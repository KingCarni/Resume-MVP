...
export const CANONICAL_SKILLS: CanonicalSkill[] = [
  ...
  { canonical: "objective-c", aliases: ["objective-c", "objective c", "objc"], category: "language" },
  { canonical: "r", aliases: ["r language", "r programming"], category: "language" },
  ...
  { canonical: "zendesk", aliases: ["zendesk"], category: "tool" },
  { canonical: "mode", aliases: ["mode", "mode analytics"], category: "tool" },
  { canonical: "looker", aliases: ["looker"], category: "tool" },
  { canonical: "tableau", aliases: ["tableau"], category: "tool" },
  { canonical: "salesforce service cloud", aliases: ["salesforce service cloud", "service cloud"], category: "tool" },
  { canonical: "ticketing systems", aliases: ["ticketing systems", "ticketing tools", "ticketing system"], category: "tool" },
...
export const CONCEPT_SIGNALS: ConceptSignal[] = [
  ...
  { canonical: "technical support", aliases: ["technical support", "support engineer", "support engineering"], category: "domain" },
  { canonical: "customer support", aliases: ["customer support", "customer experience", "world-class customer experience"], category: "domain" },
  { canonical: "customer-facing communication", aliases: ["customer-facing", "customer facing", "written and verbal communication", "written communication", "verbal communication"], category: "soft_skill" },
  { canonical: "ticket triage", aliases: ["customer tickets", "ticket triage", "respond to tickets", "ticket queue"], category: "workflow" },
  { canonical: "escalation management", aliases: ["escalate", "escalations", "customer escalations", "escalate to engineering"], category: "workflow" },
  { canonical: "time management", aliases: ["time management", "balance multiple priorities", "multiple priorities"], category: "soft_skill" },
