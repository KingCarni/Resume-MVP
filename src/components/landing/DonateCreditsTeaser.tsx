    ...
    <section className="rounded-3xl border border-white/30 bg-white/35 p-6 shadow-xl backdrop-blur-xl sm:p-10">
      <div className="max-w-3xl">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            href="/account/donate"
            className="rounded-xl bg-emerald-700 px-5 py-2 text-sm font-black text-black shadow-md transition-all duration-200 hover:scale-[1.02] hover:bg-emerald-800 hover:shadow-lg"
          >
            Donate Credits
          </Link>
        ...
        <p className="mt-6 text-xs font-extrabold text-black/90">
