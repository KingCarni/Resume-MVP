...
function buildResumeHtml(args: {
  ...
  const layoutCss = `
    ...
    ${useCorporateLayout ? `.content.corporate-layout{ display:grid; gap:18px; } .corporate-layout .section{ border:1px solid var(--line); padding:14px; background:var(--cardbg); border-radius:var(--radius); box-shadow:var(--shadow); } .corporate-layout .h{ border-bottom:1px solid var(--line); padding-bottom:8px; margin-bottom:12px; color:var(--accent); }` : ""}
  `;
